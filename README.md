...
A fitness app combining workout tracking, diet planning, and a webcam-based trainer with habit analytics. The harder problem wasn't the model, it was the interface — turning raw tracked data into something someone would actually check again the next day.

**Investment Optimizer**
A Java Swing application that optimizes multi-stage investment allocation using dynamic programming, built to compare how allocation decisions compound across stages rather than in isolation.

**Smart Traffic Management System**
A traffic control simulation using the Banker's Algorithm for deadlock avoidance, with logic for prioritizing emergency vehicles through intersections.
